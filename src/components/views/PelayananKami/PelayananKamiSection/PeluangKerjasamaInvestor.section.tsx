...
const PeluangKerjasamaInvestor = () => {
    ...
    >
      ...
      >
        ...
        <Typography variant='h4' weight='semibold'>
          {t("servicesPage.partnership.investorTitle")}
        </Typography>
      </motion.div>
            ...
            >
              ...
              >
                ...
                <Typography variant='h3' weight='semibold' className='lg:mt-8'>
                  {t("servicesPage.partnership.businessDetail")}
                </Typography>
...
export default PeluangKerjasamaInvestor;
